...
class ScopeHoistingPackager {
  ...
  async loadAssets() {
    ...
    this.bundle.traverseAssets((asset, shouldWrap) => {
      ...
      if (shouldWrap || asset.meta.shouldWrap || this.isAsyncBundle || this.bundle.env.sourceType === 'script' || this.bundleGraph.isAssetReferencedByDependant(this.bundle, asset) || this.bundleGraph.getIncomingDependencies(asset).some(dep => dep.meta.shouldWrap)) {
